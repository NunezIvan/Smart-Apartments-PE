...
void registrarConsumoAgua (const string& mes, const string& edificio, const string& tipo, const string& tipo_pago) {
   ...
   gotoxy(40, 13); cout << " Ingrese la lectura anterior: "; cin >> lec_anterior;
   gotoxy(40, 14); cout << " Ingrese la lectura actual: "; cin >> lec_actual;
   ...
   gotoxy(0, 15); cout << "-----------------------------------------------------------------------------------------------------------------------";
   gotoxy(0, 16); cout << left << "| " << "Egresos de " << setw(102) << e.mes << "    |";
   gotoxy(0, 17); cout << "-----------------------------------------------------------------------------------------------------------------------";
   gotoxy(0, 18); cout << left << "| " << setw(13) << "Lec. actual" << "| ";
   gotoxy(16, 18); cout << setw(13) << "Lec. anterior" << " | ";
   gotoxy(31, 18); cout << setw(9) << "c. m^3" << " | ";
   gotoxy(43, 18); cout << setw(6) << "F" << " | ";
   gotoxy(49, 18); cout << setw(10) << "Subtotal" << " | ";
   gotoxy(63, 18); cout << setw(4) << "F" << " | ";
   gotoxy(69, 18); cout << setw(10) << "Subtotal" << " | ";
   gotoxy(82, 18); cout << setw(10) << "Cargo Fijo" << " | ";
   gotoxy(95, 18); cout << setw(10) << "Total IGV" << " | ";
   gotoxy(108, 18); cout << setw(7) << "Total" << "    |";
   gotoxy(0, 19); cout << "-----------------------------------------------------------------------------------------------------------------------";
   gotoxy(0, 20); cout << left << "| " << setw(12) << lec_actual << " | ";
   gotoxy(16, 20); cout << setw(13) << lec_anterior << " | ";
   gotoxy(31, 20); cout << setw(9) << consumo_agua_m3 << " | ";
   gotoxy(43, 20); cout << setw(4) << VOLUMEN << " | ";
   gotoxy(49, 20); cout << "s/" << setw(8) << subtotal << " | ";
   gotoxy(63, 20); cout << setw(4) << SERVICIO_ALCANTARILLADO << " | ";
   gotoxy(69, 20); cout << "s/" << setw(8) << subtotal_desague << " | ";
   gotoxy(82, 20); cout << "s/" << setw(8) << CARGO_FIJO << " | ";
   gotoxy(95, 20); cout << "s/" << setw(8) << total_igv << " | ";
   gotoxy(108, 20); cout << "s/" << setw(8) << total << " |";
   gotoxy(0, 21); cout << "-----------------------------------------------------------------------------------------------------------------------";
